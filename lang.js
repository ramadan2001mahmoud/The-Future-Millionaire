...
function t(key) { const lang = localStorage.getItem('language') || 'ar'; return translations[lang][key] || key; }
function updateUILanguage() {
    ...
    if (langBtn) { const currentLang = localStorage.getItem('language') || 'ar'; langBtn.textContent = currentLang === 'ar' ? '🇺🇸 EN' : '🇪🇬 عربي'; }
}
