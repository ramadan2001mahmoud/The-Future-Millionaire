// ============================================
//  script.js - الملف الرئيسي (150+ أداة)
// ============================================
...
let tools = [
    ...
    { name: "Sora", category: "فيديو", url: "https://openai.com/sora", description: "توليد فيديوهات واقعية من النص", icon: "fa-cloud", clicks: 0 },
    ...
    { name: "Clash Royale", category: "ألعاب", url: "https://clashroyale.com", description: "لعبة بطاقات استراتيجية", icon: "fa-chess", clicks: 0 },
    ...
    { name: "IMO", category: "تواصل", url: "https://imo.im", description: "تطبيق مكالمات فيديو", icon: "fas fa-video", clicks: 0 },
    { name: "Viber", category: "تواصل", url: "https://www.viber.com", description: "تطبيق مكالمات ورسائل", icon: "fab fa-viber", clicks: 0 },
    { name: "Line", category: "تواصل", url: "https://line.me", description: "تطبيق تواصل شعبي", icon: "fab fa-line", clicks: 0 },
    { name: "WeChat", category: "تواصل", url: "https://www.wechat.com", description: "تطبيق التواصل الصيني", icon: "fab fa-weixin", clicks: 0 },
    { name: "KakaoTalk", category: "تواصل", url: "https://www.kakaocorp.com", description: "تطبيق التواصل الكوري", icon: "fas fa-comment", clicks: 0 },
    { name: "Messenger", category: "تواصل", url: "https://www.messenger.com", description: "تطبيق المراسلة من فيسبوك", icon: "fab fa-facebook-messenger", clicks: 0 },
    { name: "Skype", category: "تواصل", url: "https://www.skype.com", description: "تطبيق المكالمات والمؤتمرات", icon: "fab fa-skype", clicks: 0 },
    
    // ========== تطبيقات إنتاجية وترفيه وتعليم ==========
    ...
    { name: "Xender", category: "أدوات", url: "https://www.xender.com", description: "مشاركة الملفات بدون إنترنت", icon: "fas fa-wifi", clicks: 0 },
    { name: "CCleaner", category: "أدوات", url: "https://www.ccleaner.com", description: "تنظيف الجهاز وتحسين الأداء", icon: "fas fa-broom", clicks: 0 },
    { name: "Norton Security", category: "أدوات", url: "https://norton.com", description: "حماية الجهاز من الفيروسات", icon: "fas fa-shield-alt", clicks: 0 }
];
